// QUOTA LEVEL: LIGHT
// PURPOSE: Verify Karabük AOI boundary and SRTM DEM load correctly
...
print('=== KARABÜK BOUNDARY TEST ===');
print('AOI area (km²):', aoi.area().divide(1e6).round());
...
Map.addLayer(aoiOutline, {palette: ['FF0000']}, 'Karabük Boundary');
...
print('1. Red boundary outline visible around Karabük');
print('2. Area should be between 3000-5000 km²');
print('3. Elevation min > 0, max < 3000');
print('4. No red errors in Console');
print('If all pass → open gee/02_flood_imagery.js next');
